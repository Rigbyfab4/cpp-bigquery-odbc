...
TEST(DataFetchPerformanceParamTest, BenchmarSQLFetch) {
  auto conn = std::make_shared<ODBCHandles>();
  ...
  std::string query = "SELECT nyc311.unique_key AS V1, nyc311.descriptor AS V2, nyc311.open_data_channel_type AS V3, nyc311.status AS V4, nyc311.incident_address AS V5, nyc311.street_name AS V7, nyc311.city AS V8, nyc311.incident_zip AS V9, nyc311.borough AS V10, nyc311.x_coordinate AS V11, nyc311.y_coordinate AS V12, nyc311.latitude AS V13, nyc311.longitude AS V14, nyc311.location AS V15, nyc311.community_board AS V16, NULL AS V17, NULL AS V18, CAST(nyc311.resolution_action_updated_date AS STRING) AS V19, CAST(nyc311.created_date AS STRING) AS V20, CAST(nyc311.resolution_action_updated_date AS STRING) AS V21, CAST(nyc311.closed_date AS STRING) AS V22 FROM `bigquery-public-data.new_york_311.311_service_requests` AS nyc311 LIMIT 200000;";
