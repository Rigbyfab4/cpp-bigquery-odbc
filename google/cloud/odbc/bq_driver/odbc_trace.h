...
void TraceFunctionEntry_SQLDriverConnect(
    ...
    SQLCHAR *in_connection_str,
    SQLSMALLINT in_connection_str_len, SQLCHAR *out_conn_str,
...
void TraceFunctionEntry_SQLGetInfo(
    SQLHDBC connection_handle, SQLUSMALLINT info_type, SQLPOINTER info_value,
...
void TraceFunctionEntry_SQLGetTypeInfo(
    SQLHSTMT statement_handle, SQLSMALLINT data_type,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLSetDescRec(
    ...
    SQLLEN desc_oct_len, SQLSMALLINT desc_prec,
    SQLSMALLINT desc_sc,
    SQLPOINTER desc_data, SQLLEN *desc_oct_len_ptr, SQLLEN *desc_ind,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLBindParameter(
    ...
    SQLSMALLINT param_type, SQLSMALLINT param_c_type, SQLSMALLINT param_sql_type,
...
void TraceFunctionEntry_SQLDescribeParam(
    ...
    SQLULEN *param_sz, SQLSMALLINT *param_scale, SQLSMALLINT *param_nullable,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLGetData(
    ...
    SQLLEN target_val_buf_len, SQLLEN *target_val_str_len,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLExtendedFetch(
    SQLHSTMT statement_handle, SQLUSMALLINT fetch_orientation,
    SQLLEN fetch_offset,
...
void TraceFunctionEntry_SQLColAttribute(
    ...
    SQLSMALLINT *char_attr_str_len, SQLLEN *numeric_attr,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLDescribeColW(
    SQLHSTMT statement_handle, SQLUSMALLINT col_num,
    SQLWCHAR *col_name, SQLSMALLINT col_name_buf_len,
    SQLSMALLINT *col_name_len, SQLSMALLINT *col_sql_data_type,
    SQLULEN *col_sz, SQLSMALLINT *dec_digits,
...
void TraceFunctionEntry_SQLRowCount(
    SQLHSTMT statement_handle, SQLLEN *row_count,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLTablesW(
    ...
    SQLWCHAR *schema_name, SQLSMALLINT schema_name_len,
    SQLWCHAR *table_name,
    SQLSMALLINT table_name_len, SQLWCHAR *table_type, SQLSMALLINT table_type_len,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLProceduresW(
    ...
    SQLSMALLINT catalog_name_len,
    SQLWCHAR *schema_name, SQLSMALLINT schema_name_len,
    SQLWCHAR *proc_name, SQLSMALLINT proc_name_len,
    TraceOptions opts = {});
void TraceFunctionExit_SQLProceduresW(
    SQLRETURN ret_code, TraceOptions opts = {});

void TraceFunctionEntry_SQLSpecialColumns(
    SQLHSTMT statement_handle, SQLUSMALLINT id_type,
    SQLCHAR *catalog_name, SQLSMALLINT catalog_name_len,
    SQLCHAR *schema_name,
...
void TraceFunctionEntry_SQLSpecialColumnsW(
    SQLHSTMT statement_handle, SQLUSMALLINT id_type,
    SQLWCHAR *catalog_name, SQLSMALLINT catalog_name_len, SQLWCHAR *schema_name,
    SQLSMALLINT schema_name_len, SQLWCHAR *table_name, SQLSMALLINT table_name_len,
    SQLUSMALLINT min_rowid_scope, SQLUSMALLINT col_nullable,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLTablePrivileges(
    SQLHSTMT statement_handle, SQLCHAR *catalog_name, SQLSMALLINT catalog_name_len,
    SQLCHAR *schema_name, SQLSMALLINT schema_name_len, SQLCHAR *table_name,
    SQLSMALLINT table_name_len, TraceOptions opts = {});
...
void TraceFunctionEntry_SQLTablePrivilegesW(
    SQLHSTMT statement_handle, SQLWCHAR *catalog_name, SQLSMALLINT catalog_name_len,
...
void TraceFunctionEntry_SQLForeignKeys(
    ...
    SQLSMALLINT pk_catalog_name_len,
    SQLCHAR *pk_schema_name, SQLSMALLINT pk_schema_name_len,
    ...
    SQLCHAR *fk_table_name, SQLSMALLINT fk_table_name_len,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLForeignKeysW(
    ...
    SQLSMALLINT pk_catalog_name_len,
    SQLWCHAR *pk_schema_name, SQLSMALLINT pk_schema_name_len,
    ...
    SQLWCHAR *fk_table_name, SQLSMALLINT fk_table_name_len,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLEndTran(
    SQLSMALLINT handle_type, SQLHANDLE handle, SQLSMALLINT completion_type,
    TraceOptions opts = {});
...
void TraceFunctionEntry_SQLSetPos(
    ...
    SQLUSMALLINT op, SQLUSMALLINT lock_type,
    TraceOptions opts = {});
