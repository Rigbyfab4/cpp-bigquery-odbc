...
void TraceFunctionEntry_SQLBindParameter(
    ...
    SQLSMALLINT param_type, SQLSMALLINT param_c_type,
    ...
    if (opts.logging_enabled)
    {
        if (opts.trace_file.is_open())
        {
            CollectAndPrintArgsFile(
                ...
                ToCStr(FormatSqlULen(col_sz)),
                ToCStr(FormatSqlSmallInt(dec_digits)),
...
void TraceFunctionEntry_SQLDescribeColW(
    SQLHSTMT statement_handle,
    SQLUSMALLINT col_num, SQLWCHAR *col_name,
    SQLSMALLINT col_name_buf_len, SQLSMALLINT *col_name_len,
    SQLSMALLINT *col_sql_data_type, SQLULEN *col_sz,
...
void TraceFunctionEntry_SQLSpecialColumnsW(
    SQLHSTMT statement_handle, SQLUSMALLINT id_type,
    SQLWCHAR *catalog_name, SQLSMALLINT catalog_name_len,
